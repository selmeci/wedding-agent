export function Groom({ className = "" }: { className?: string }) {
	return (
		...
		>
			...
			<rect x="26" y="44" width="1" height="18" fill="#111827" opacity="0.3" />{" "}
			{/* Crease/Shadow */}
			{/* Right Leg */}
			<rect x="34" y="44" width="6" height="18" fill="#1F2937" />
			<rect x="34" y="62" width="8" height="2" fill="#111827" /> {/* Shoe */}
			<rect x="37" y="44" width="1" height="18" fill="#111827" opacity="0.3" />{" "}
			{/* Crease/Shadow */}
			{/* === TORSO (Suit) === */}
			<rect x="22" y="26" width="20" height="18" fill="#1F2937" />
			{/* Jacket Shadow/Shape */}
			<rect x="22" y="42" width="20" height="2" fill="#111827" opacity="0.4" />{" "}
			{/* Hem */}
			{/* White Shirt Area */}
			...
			<rect x="18" y="40" width="4" height="2" fill="#FFFFFF" opacity="0.8" />{" "}
			{/* Cuff */}
			{/* Right Arm (Relaxed at side) */}
			<rect x="42" y="28" width="4" height="14" fill="#1F2937" />
			<rect x="42" y="42" width="4" height="4" fill="#FFD4A3" /> {/* Hand */}
			<rect x="42" y="40" width="4" height="2" fill="#FFFFFF" opacity="0.8" />{" "}
			{/* Cuff */}
			{/* === HEAD === */}
			{/* Neck */}
			...
			{/* Right Eye */}
			<rect x="29" y="20" width="6" height="1" fill="#D97706" opacity="0.6" />{" "}
			{/* Smile */}
			<rect x="28" y="19" width="1" height="1" fill="#D97706" opacity="0.4" />{" "}
			{/* Corner */}
			<rect x="35" y="19" width="1" height="1" fill="#D97706" opacity="0.4" />{" "}
			{/* Corner */}
			{/* Hair (Dark Brown) */}
