export function WeddingCouple({ className = "" }: { className?: string }) {
	return (
		...
		>
			...
			<rect x="29" y="23" width="3" height="1" fill="#C29470" opacity="0.6" />{" "}
			{/* Smile shadow */}
			{/* Hair */}
			...
			<rect x="46" y="30" width="6" height="4" fill="#FFE3E8" opacity="0.3" />{" "}
			{/* Subtle detail */}
			{/* -- Arms -- */}
			{/* Right Arm (down) */}
			...
			<rect x="45" y="24" width="2" height="1" fill="#D97706" opacity="0.5" />{" "}
			{/* Lips */}
			{/* Hair */}
