export function Bride({ className = "" }: { className?: string }) {
	return (
		...
		>
			...
			{/* Lighter top */}
			<rect x="26" y="32" width="12" height="4" fill="#FFE3E8" opacity="0.3" />{" "}
			{/* Slight pink tint */}
			{/* Neckline */}
			...
			{/* Right Eye */}
			<rect x="27" y="21" width="2" height="2" fill="#FF9BB0" opacity="0.4" />{" "}
			{/* Cheek */}
			<rect x="35" y="21" width="2" height="2" fill="#FF9BB0" opacity="0.4" />{" "}
			{/* Cheek */}
			<rect x="30" y="23" width="4" height="1" fill="#D97706" opacity="0.6" />{" "}
			{/* Smile */}
			{/* === HAIR (Blonde) === */}
